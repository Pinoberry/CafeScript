...
const Hero: React.FC = () => {
  return (
    <section
      id="inicio"
      className="relative h-screen max-h-[800px] min-h-[600px] bg-gradient-to-r from-coffee-900 to-coffee-700"
    >
      <div
      ...
      <div className="relative container mx-auto px-4 h-full flex items-center">
        <div className="text-cream-50 max-w-2xl">
          ...
          <p className="text-xl md:text-2xl lg:text-3xl mb-8 text-cream-100 max-w-3xl">
            Descubre los sabores únicos de nuestras regiones, desde la Araucanía
            hasta Valparaíso
          </p>
          <a
            href="#productos"
